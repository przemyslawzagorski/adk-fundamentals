...
## Wszystko w jednym — działa od pierwszej minuty

Analyst System dostarcza kompletny ekosystem narzędziowy out-of-the-box. Lokalne narzędzia zapewniają pełną funkcjonalność bez zależności zewnętrznych. Integracje z Jira, Wiki i GitLab rozszerzają możliwości — ale nie warunkują ich.
...
!!! info "Model Context Protocol"
    MCP to otwarty standard komunikacji między agentami AI a zewnętrznymi systemami. Pozwala na bezpieczny, kontrolowany dostęp do danych — **bez konieczności budowania dedykowanych integracji**. Jest opcjonalny — system działa w pełni bez niego.
