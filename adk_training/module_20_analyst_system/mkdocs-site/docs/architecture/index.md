...
### Dwie pętle + Meta Skills

**Pętla realizacji** wykonuje zadania. **Pętla wiedzy** buduje umiejętności. Razem tworzą system, który się doskonali — a meta skills zamykają cykl, pozwalając systemowi **sam się rozbudowywać**.
...
System, który sam tworzy nowe umiejętności — compound knowledge effect

[Meta Skills :material-arrow-right:](meta-skills.md)
