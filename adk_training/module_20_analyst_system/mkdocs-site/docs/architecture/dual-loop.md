...
## Pętla wiedzy — Meta Skill Engine

Unikalna cecha systemu. Pipeline 6-krokowy, który autonomicznie buduje nowe umiejętności z wiedzy rozproszonej po projekcie. To **meta skill** — umiejętność tworzenia umiejętności.
...
!!! success "Efekt kumulatywny — Compound Knowledge"
    Każda nowa umiejętność trafia do repozytorium i jest automatycznie odkrywana przez przyszłe uruchomienia. System staje się lepszy z każdym użyciem — **bez zmian w kodzie**. To fundamentalna różnica wobec statycznych systemów AI.

    [:material-arrow-right: Pełne omówienie Meta Skills](meta-skills.md)
...
graph TB
    AL["Pętla realizacji"]
    KL["Pętla wiedzy<br/><small>Meta Skill Engine</small>"]
    ...
    style QF fill:#3b82f6,color:#fff,stroke:none
```
