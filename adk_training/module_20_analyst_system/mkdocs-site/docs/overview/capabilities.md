...
=== "Meta Skills :material-infinity:"

    **System, który sam się rozbudowuje — compound knowledge effect**

    Umiejętności generowane przez Knowledge Loop trafiają do repozytorium i są automatycznie odkrywane przez przyszłe zadania. Każda nowa umiejętność podnosi jakość **wszystkich** kolejnych wyników — bez zmian w kodzie.

    ```mermaid
    graph LR
        W1["Tydzień 1<br/><small>4 skille bazowe</small>"]
        W2["Miesiąc 1<br/><small>+6 wygenerowanych</small>"]
        W3["Kwartał<br/><small>20+ skilli</small>"]

        W1 -->|"System uczy się"| W2
        W2 -->|"Jakość rośnie"| W3
    ...
    > Koszt generowania wiedzy spada. Jakość rośnie. Wiedza nie odchodzi z ludźmi.

    [:material-arrow-right: Pełny opis Meta Skills](../architecture/meta-skills.md)
---
