...
from ..tools.mcp_setup import get_comarch_mcp
...
comarch_mcp = get_comarch_mcp()
_mcp_tools = [comarch_mcp] if comarch_mcp else []
...
""",
    tools=[tool_read_file, tool_list_files] + _mcp_tools,
