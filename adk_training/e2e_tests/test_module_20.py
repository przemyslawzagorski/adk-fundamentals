...
# Ensure SKILLS_DIR is absolute so skill/template tools work regardless of CWD
...
def test_skill_tools():
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            _saved_skills = os.environ.get("SKILLS_DIR")
            ...
            # Restore SKILLS_DIR
            if _saved_skills:
                os.environ["SKILLS_DIR"] = _saved_skills
