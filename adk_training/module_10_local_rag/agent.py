...
# Model embeddingów — konfiguracja zależy od trybu
# Jeśli GOOGLE_GENAI_USE_VERTEXAI=1, użyj Vertex AI; w przeciwnym razie GOOGLE_API_KEY
_use_vertexai = os.environ.get("GOOGLE_GENAI_USE_VERTEXAI", "0") == "1"
if _use_vertexai:
    _embedding_model = GoogleGenAIEmbedding(
    ...
    _embedding_model = None  # FilesRetrieval użyje domyślnego (wymaga GOOGLE_API_KEY)
